...
export const useSearchableCoinListTemplate = (
  ...
  return {
    ...
    filterPanelProps: {
      ...
      showOnlyFavoritesField: options.routeConfig.supportsOnlyFavorites === true,
      onlyFavoritesValue: routeState.draftState.onlyFavorites,
      onOnlyFavoritesChange: routeState.setDraftOnlyFavorites,
